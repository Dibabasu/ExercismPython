...
def send_to_store(cart, aisle_mapping):
    ...
    return {
        item: [cart[item], aisle_mapping[item][0], aisle_mapping[item][1]] if item in aisle_mapping else cart[item]
...
def update_store_inventory(fulfillment_cart, store_inventory):
    ...
    for item in fulfillment_cart:
        if item in store_inventory:
            ...
            store_inventory[item][0] = new_count if new_count > 0 else 'Out of Stock'
